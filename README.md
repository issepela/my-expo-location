This is a small variation of expo-location that gives the height above the ellipsoid WGS84 also on Android an on iOS
on swift - iOS the logic is:
...
orignial info about expo-location
